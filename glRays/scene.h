...
struct Material
{
	glm::vec3 colour;             // offset 0   // alignment 16  // size 12  // total 12 bytes
    float emission_strength;      // offset 12  // alignment 4   // size 4   // total 16 bytes
    glm::vec3 emission_colour;    // offset 16  // alignment 16  // size 12  // total 28 bytes
...
struct Sphere
{
	...
	glm::vec3 centre;             // offset 32  // alignment 16  // size 12  // total 44 bytes
...
SceneData defaultScene() {
    ...
    sphere2.radius = 2.0f;
    sphere2.material.colour = glm::vec3(0.0f, 0.0f, 0.0f);
    sphere2.material.emission_colour = glm::vec3(1.0f, 1.0f, 1.0f);
    sphere2.material.emission_strength = 2.5f;

    Sphere sphere3;
    sphere3.centre = glm::vec3(-0.8f, 0.2f, -1.5f);
    sphere3.radius = 0.25f;
    sphere3.material.colour = glm::vec3(1.0f, 1.0f, 0.9f); // skin colour
    sphere3.material.emission_colour = glm::vec3(0.0f, 0.0f, 0.0f);
    sphere3.material.emission_strength = 0.0f;

    Sphere sphere4;
    sphere4.centre = glm::vec3(0.9f, 0.23f, -1.5f);
    sphere4.radius = 0.4f;
